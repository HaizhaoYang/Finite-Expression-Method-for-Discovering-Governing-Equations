...
# unary_functions = [lambda x: x+0*x**2,lambda x: x**2,
#                    lambda x: x**3,torch.exp,lambda x: 1+0 * x ** 2]
#                    # lambda x: 0*x**2,
#                    # lambda x: 1 + 0 * x ** 2,
#                    # lambda x: x**2,
#                    # lambda x: x**3,
...
# unary_functions = [lambda x: x+0*x**2,lambda x: x**2,lambda x: x**3,torch.sin]
...
# unary_functions_str_leaf= ['({})','(({})**2)','(({})**3)','(sin({}))']
...
if __name__ == '__main__':
    ...
    left = -1
    right = 1
    points = (torch.rand(batch_size, dim)) * (right - left) + left
