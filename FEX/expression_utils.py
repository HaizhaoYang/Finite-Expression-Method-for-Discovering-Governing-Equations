...
class Expression(nn.Module):
    ...
    def forward(self, x):
        #print(x.shape)
        # print(type(self.expression), self.expression)
        # time.sleep(3)
...
def optimize_constants(expressions, X_constants, y_constants, u_obs_constants, partial_constants, inner_lr, inner_num_epochs, optimizer):
    ...
    if (optimizer=='lbfgs'):
        def closure():
            ...
            # print(X_constants.shape)
            y = (y+partial_constants)*1e-2 + u_obs_constants
